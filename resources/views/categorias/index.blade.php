    ...
    <div class="row">
        <div class="col">
            <table class="tabela_categoria table align-middle caption-top table-striped">
                <caption>Tabela de <b>Categorias</b>
                    <a href="{{ route('categorias.create') }}" class="btn-edit btn btn-primary ms-2">
                ...
                <tbody>
                    @foreach ($categorias as $item)
                        <tr>
                            ...
                            <td>{{ $item->area }}</td>
                            <td>
                                <a href="{{ route('categorias.edit', $item['id']) }}" class="btn btn-success">
